...
def scrape_and_update(category, brand, model, year_from, year_to, custom_url=""):
    ...
    # Wykorzystanie natywnego formatu, o którym sama wspomniałaś
    ...
    # Koszyki cenowe (wymuszają pokazanie innych aut bez potrzeby paginacji)
    ...
    for p_min, p_max in price_brackets:
        ...
        for art in articles:
            ...
            # MIEJSCE NAPRAWY: Twarde wyciąganie rocznika
            year = None
            ...
            # TWARDY ODRZUT: Jeśli nie znaleziono rocznika lub nie mieści się w widełkach - Wyrzucamy!
            if not year:
                continue
